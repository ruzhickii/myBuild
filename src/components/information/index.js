                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-2">
                            <div className="animated lightSpeedIn" style={styles.imgBlock}>
                                <img style={styles.img} src={image} alt="image"/>
                            </div>
                        </div>
                        <div className="col-md-10">
                            <div className="animated bounceInRight" style={styles.headerText}>
                                HEY GUYS! THIS IS MY
                            </div>
                            <div className="animated bounceInRight" style={styles.what}>
                                PAGE ONE CARD-SIMPLE VCARD AND RESUME PSD TEMPLATE
                            </div>
                            <div className="animated bounceInRight" style={styles.how}>
                                CLEAN, SIMPLE, MINIMALIS AND ALSO FEEL FREE THE QUALITY OF THE TEMPLATE!
                            </div>
                            <div className="animated bounceInRight" style={styles.text}>
                    ...
                    <div className="row">
                        <div className="col-md-4">
                            <div className="animated bounceInUp" style={styles.infoMainBlock}>
                                NAME:<span style={styles.infoText}> Ruzhickii Alexander</span>
                                <div style={styles.line}></div>
                            </div>
                            <div className="animated bounceInUp" style={styles.infoBlock}>
